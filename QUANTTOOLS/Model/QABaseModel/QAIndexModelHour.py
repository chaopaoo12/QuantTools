import pandas as pd
from QUANTTOOLS.Model.FactorTools.QuantMk import get_index_quant_hour
...
class QAIndexModelHour(QAModel):
    ...
    def model_predict(self, start, end, code = None, type='crawl'):
        ...
        if type == 'crawl':
            train = train.join(data[['TERNS_HR','PASS_MARK','INDEX_TARGET','INDEX_TARGET3','INDEX_TARGET4','INDEX_TARGET5','INDEX_TARGET10']])
            b = train[['TERNS_HR','y_pred','Z_PROB','O_PROB','RANK','PASS_MARK','INDEX_TARGET','INDEX_TARGET3','INDEX_TARGET4','INDEX_TARGET5','INDEX_TARGET10']]
        elif type == 'model':
