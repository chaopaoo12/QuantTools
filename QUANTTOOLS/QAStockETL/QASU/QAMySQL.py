...
def QA_etl_index_to_stock(ui_log= None):
    ...
    res = pd.merge(index_info[['code','index_name']], index_code,
                   left_on = ['index_name'], right_on = ['index_name'], how='left').dropna()[['code','stock','index_name']].drop_duplicates(subset=['code','stock'])
    QA_util_log_info(
