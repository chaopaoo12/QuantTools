...
def QA_etl_stock_financial_percent_day(start_date = QA_util_today_str(), end_date= None, ui_log= None):
    ...
    codes = list(QA_fetch_stock_list_adv()['code'])
    data = QA_fetch_stock_financial_percent_adv(codes, start_date, end_date).data[['PE_10PCT','PE_10VAL','PEEGL_10PCT','PEEGL_10VAL','PB_10PCT','PB_10VAL',
                                                                                   #'PEG_10PCT','PEG_10VAL',
                                                                                   'PS_10PCT','PS_10VAL',
...
def QA_etl_index_alpha_day(start_date = QA_util_today_str(), end_date= None, ui_log= None):
    ...
    data = QA_fetch_index_alpha_adv(codes, start_date, end_date).data[['alpha_001','alpha_002','alpha_003','alpha_004','alpha_005',
                                                             ...
                                                             'alpha_038','alpha_039','alpha_040','alpha_041','alpha_042',
                                                             'alpha_043','alpha_044','alpha_045','alpha_046','alpha_047',
                                                             'alpha_048','alpha_049','alpha_052','alpha_053','alpha_054',
                                                             'alpha_056','alpha_057','alpha_058','alpha_059','alpha_060',
                                                             'alpha_061','alpha_062','alpha_063','alpha_064','alpha_065',
                                                             'alpha_066','alpha_067','alpha_068','alpha_070','alpha_071',
                                                             'alpha_072','alpha_074','alpha_076','alpha_077','alpha_078',
                                                             'alpha_079','alpha_080','alpha_081','alpha_082','alpha_083',
                                                             'alpha_084','alpha_085','alpha_086','alpha_087','alpha_088',
                                                             'alpha_089','alpha_090','alpha_091','alpha_092','alpha_093',
                                                             'alpha_094','alpha_095','alpha_096','alpha_097','alpha_098',
                                                             'alpha_099','alpha_100','alpha_101','alpha_102','alpha_103',
                                                             'alpha_104','alpha_105','alpha_106','alpha_107','alpha_108',
                                                             'alpha_109','alpha_110','alpha_111','alpha_112','alpha_113',
                                                             'alpha_114','alpha_115','alpha_116','alpha_117','alpha_118',
                                                             'alpha_119','alpha_120','alpha_122','alpha_123','alpha_124',
                                                             'alpha_125','alpha_126','alpha_129','alpha_130','alpha_132',
                                                             'alpha_133','alpha_134','alpha_135','alpha_136','alpha_138',
                                                             'alpha_139','alpha_141','alpha_142','alpha_144','alpha_145',
                                                             'alpha_148','alpha_150','alpha_152','alpha_153','alpha_154',
                                                             'alpha_155','alpha_156','alpha_157','alpha_158','alpha_159',
                                                             'alpha_160','alpha_161','alpha_162','alpha_163','alpha_164',
                                                             'alpha_167','alpha_168','alpha_169','alpha_170','alpha_171',
