...
def pct(data):
    ...
    data['LAG_MARKET']= data['close_qfq'].shift(1).apply(lambda x:round(x * 100,2))
    data['LAG2_MARKET']= data['close_qfq'].shift(2).apply(lambda x:round(x * 100,2))
    data['LAG3_MARKET']= data['close_qfq'].shift(3).apply(lambda x:round(x * 100,2))
    data['LAG5_MARKET']= data['close_qfq'].shift(5).apply(lambda x:round(x * 100,2))
    data['LAG20_MARKET']= data['close_qfq'].shift(20).apply(lambda x:round(x * 100,2))
    data['LAG30_MARKET']= data['close_qfq'].shift(30).apply(lambda x:round(x * 100,2))
    data['LAG60_MARKET']= data['close_qfq'].shift(60).apply(lambda x:round(x * 100,2))
    data['AVG_LAG_MARKET']= data['AVG_TOTAL_MARKET'].shift(1).apply(lambda x:round(x * 100,2))
    data['AVG_LAG2_MARKET']= data['AVG_TOTAL_MARKET'].shift(2).apply(lambda x:round(x * 100,2))
    data['AVG_LAG3_MARKET']= data['AVG_TOTAL_MARKET'].shift(3).apply(lambda x:round(x * 100,2))
    data['AVG_LAG5_MARKET']= data['AVG_TOTAL_MARKET'].shift(5).apply(lambda x:round(x * 100,2))
    data['AVG_LAG20_MARKET']= data['AVG_TOTAL_MARKET'].shift(20).apply(lambda x:round(x * 100,2))
    data['AVG_LAG30_MARKET']= data['AVG_TOTAL_MARKET'].shift(30).apply(lambda x:round(x * 100,2))
    data['AVG_LAG60_MARKET']= data['AVG_TOTAL_MARKET'].shift(60).apply(lambda x:round(x * 100,2))
