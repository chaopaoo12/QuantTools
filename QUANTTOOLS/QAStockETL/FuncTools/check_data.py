...
def check_stock_fianacial(mark_day = None, type = 'day', ui_log = None):
    code = list(QA_fetch_stock_list_adv()['code'])
    if type == 'day' and mark_day is None:
        mark_day = QA_util_today_str()
    ...
    if data1 is None:
        ...
        QA_util_log_info(
            '##JOB Now Check Financial day data ============== {deal_date}: {num1} to {to_date}: {num2} '.format(deal_date=mark_day,num1=data1.shape[0],
                                                                                                                 to_date=to_date,num2=data2.shape[0]), ui_log)
...
def check_stock_quant(mark_day = None, type = 'day', ui_log = None):
    code = list(QA_fetch_stock_list_adv()['code'])
    if type == 'day' and mark_day is None:
        mark_day = QA_util_today_str()
    ...
    if data1 is None:
        ...
        QA_util_log_info(
            '##JOB Now Check Stock Quant day data ============== {deal_date}: {num1} to {to_date}: {num2} '.format(deal_date=mark_day,num1=data1.shape[0],
                                                                                                                 to_date=to_date,num2=data2.shape[0]), ui_log)
...
def check_index_quant(mark_day = None, type = 'day', ui_log = None):
    ...
    if data1 is None:
        ...
        QA_util_log_info(
            '##JOB Now Check Index Quant day data ============== {deal_date}: {num1} to {to_date}: {num2} '.format(deal_date=mark_day,num1=data1.shape[0],
                                                                                                                   to_date=to_date,num2=data2.shape[0]), ui_log)
