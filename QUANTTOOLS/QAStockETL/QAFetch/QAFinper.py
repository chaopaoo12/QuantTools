...
def perank(data):
    ...
    data[['PB_60VAL','PB_60DN','PB_60UP','PE_60VAL','PE_60DN','PE_60UP','PEEGL_60VAL','PEEGL_60DN','PEEGL_60UP','PEG_60VAL','PEG_60DN','PEG_60UP','PS60VAL','PS_60DN','PS_60UP']] = rolling_calc(data, 30)
    data[['PB_90VAL','PB_90DN','PB_90UP','PE_90VAL','PE_90DN','PE_90UP','PEEGL_90VAL','PEEGL_90DN','PEEGL_90UP','PEG_90VAL','PEG_90DN','PEG_90UP','PS90VAL','PS_90DN','PS_90UP']] = rolling_calc(data, 30)
