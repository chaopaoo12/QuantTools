...
def perank(data):
    ...
    data['PE_5VAL']= data['PE'].rolling(window=5).apply(lambda x: (pd.DataFrame(x)-pd.DataFrame(x).median())/pd.DataFrame(x).median().iloc[-1],raw=True)
    data['PE_10VAL']= data['PE'].rolling(window=10).apply(lambda x: (pd.DataFrame(x)-pd.DataFrame(x).median())/pd.DataFrame(x).median().iloc[-1],raw=True)
    data['PE_20VAL']= data['PE'].rolling(window=20).apply(lambda x: (pd.DataFrame(x)-pd.DataFrame(x).median())/pd.DataFrame(x).median().iloc[-1],raw=True)
    data['PE_30VAL']= data['PE'].rolling(window=30).apply(lambda x: (pd.DataFrame(x)-pd.DataFrame(x).median())/pd.DataFrame(x).median().iloc[-1],raw=True)
    data['PE_60VAL']= data['PE'].rolling(window=60).apply(lambda x: (pd.DataFrame(x)-pd.DataFrame(x).median())/pd.DataFrame(x).median().iloc[-1],raw=True)
    ...
    data['PB_5VAL']= data['PB'].rolling(window=5).apply(lambda x: (pd.DataFrame(x)-pd.DataFrame(x).median())/pd.DataFrame(x).median().iloc[-1],raw=True)
    data['PB_10VAL']= data['PB'].rolling(window=10).apply(lambda x: (pd.DataFrame(x)-pd.DataFrame(x).median())/pd.DataFrame(x).median().iloc[-1],raw=True)
    data['PB_20VAL']= data['PB'].rolling(window=20).apply(lambda x: (pd.DataFrame(x)-pd.DataFrame(x).median())/pd.DataFrame(x).median().iloc[-1],raw=True)
    data['PB_30VAL']= data['PB'].rolling(window=30).apply(lambda x: (pd.DataFrame(x)-pd.DataFrame(x).median())/pd.DataFrame(x).median().iloc[-1],raw=True)
    data['PB_60VAL']= data['PB'].rolling(window=60).apply(lambda x: (pd.DataFrame(x)-pd.DataFrame(x).median())/pd.DataFrame(x).median().iloc[-1],raw=True)
    ...
    data['PEG_5VAL']= data['PEG'].rolling(window=5).apply(lambda x: (pd.DataFrame(x)-pd.DataFrame(x).median())/pd.DataFrame(x).median().iloc[-1],raw=True)
    data['PEG_10VAL']= data['PEG'].rolling(window=10).apply(lambda x: (pd.DataFrame(x)-pd.DataFrame(x).median())/pd.DataFrame(x).median().iloc[-1],raw=True)
    data['PEG_20VAL']= data['PEG'].rolling(window=20).apply(lambda x: (pd.DataFrame(x)-pd.DataFrame(x).median())/pd.DataFrame(x).median().iloc[-1],raw=True)
    data['PEG_30VAL']= data['PEG'].rolling(window=30).apply(lambda x: (pd.DataFrame(x)-pd.DataFrame(x).median())/pd.DataFrame(x).median().iloc[-1],raw=True)
    data['PEG_60VAL']= data['PEG'].rolling(window=60).apply(lambda x: (pd.DataFrame(x)-pd.DataFrame(x).median())/pd.DataFrame(x).median().iloc[-1],raw=True)
    ...
    data['PS_5VAL']= data['PS'].rolling(window=5).apply(lambda x: (pd.DataFrame(x)-pd.DataFrame(x).median())/pd.DataFrame(x).median().iloc[-1],raw=True)
    data['PS_10VAL']= data['PS'].rolling(window=10).apply(lambda x: (pd.DataFrame(x)-pd.DataFrame(x).median())/pd.DataFrame(x).median().iloc[-1],raw=True)
    data['PS_20VAL']= data['PS'].rolling(window=20).apply(lambda x: (pd.DataFrame(x)-pd.DataFrame(x).median())/pd.DataFrame(x).median().iloc[-1],raw=True)
    data['PS_30VAL']= data['PS'].rolling(window=30).apply(lambda x: (pd.DataFrame(x)-pd.DataFrame(x).median())/pd.DataFrame(x).median().iloc[-1],raw=True)
    data['PS_60VAL']= data['PS'].rolling(window=60).apply(lambda x: (pd.DataFrame(x)-pd.DataFrame(x).median())/pd.DataFrame(x).median().iloc[-1],raw=True)
    return(data)
...
def QA_fetch_get_stock_financial_percent(code,start_date,end_date):
    ...
    fianacial = fianacial[[x for x in list(fianacial.columns) if x not in ['PB', 'PE', 'PEG', 'PS']]].apply(lambda x:round(x - 1, 2))
