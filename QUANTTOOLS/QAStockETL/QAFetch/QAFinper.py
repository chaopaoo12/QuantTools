...
def perank(data):
    ...
    data['PE_5VAL']= data['PE'].rolling(window=5).apply(lambda x: (pd.DataFrame(x)/pd.DataFrame(x).median()-1).iloc[-1].apply(lambda x:round(x , 2)),raw=True)
    ...
    data['PB_5VAL']= data['PB'].rolling(window=5).apply(lambda x: (pd.DataFrame(x)/pd.DataFrame(x).median()-1).iloc[-1].apply(lambda x:round(x , 2)),raw=True)
    ...
    data['PEG_5VAL']= data['PEG'].rolling(window=5).apply(lambda x: (pd.DataFrame(x)/pd.DataFrame(x).median()-1).iloc[-1].apply(lambda x:round(x , 2)),raw=True)
    ...
    data['PS_5VAL']= data['PS'].rolling(window=5).apply(lambda x: (pd.DataFrame(x)/pd.DataFrame(x).median()-1).iloc[-1].apply(lambda x:round(x , 2)),raw=True)
