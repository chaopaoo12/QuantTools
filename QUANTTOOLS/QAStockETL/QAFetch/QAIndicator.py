...
def get_indicator_short(data, type='day'):
    ...
    try:
        ...
        MA['RRNG'] = MA[['MA5','MA10','C_V','MIN_V']].apply(lambda x: np.where(x.MA5 < x.MA10, x.C_V/x.MIN_V, -x.C_V/x.MIN_V))
        ...
        MA['MAX_V'] = MA[['MA5','MA10','MA20','MA60']].max(axis=1)
        MA['C_V'] = MA['MAX_V'] - MA['MIN_V']
        MA['RRNG'] = MA[['MA5','MA10','C_V','MIN_V']].to_frame().apply(lambda x: np.where(x.MA5 < x.MA10, x.C_V/x.MIN_V, -x.C_V/x.MIN_V))
        MA['SHORT10'] = MA['MA5']/MA['MA10']-1
        MA['SHORT20'] = MA['MA10']/MA['MA20']-1
        MA['SHORT60'] = MA['MA10']/MA['MA60']-1
        MA['LONG60'] = MA['MA20']/MA['MA60']-1
