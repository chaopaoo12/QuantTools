...
def QA_Sql_USStock_Alpha191(from_ , to_, sql_text = sql_text, ui_log= None):
    QA_util_log_info(
        '##JOB01 Now Fetch USStock QuantData Alpha191 ==== from {from_} to {to_}'.format(from_=from_,to_=to_), ui_log)
