...
def QA_Sql_Stock_Alpha191_neut(from_ , to_, code=None, sql_text = sql_text, ui_log= None):
    QA_util_log_info(
        '##JOB01 Now Fetch Stock QuantData Alpha191 NEUT ==== from {from_} to {to_}'.format(from_=from_,to_=to_), ui_log)
