...
def QA_util_etl_stock_financial(start_date):
    sql = '''select A.CODE,
       ...
       A.INVENTORY_LY,
       A.MONEYFUNDS_LY,
       A.ACCOUNTSPAYABLE_LY,
       A.AVGACCOUNTSPAYABLE_LY,
       A.AVGINVENTORY_LY,
       A.TOTALLIQUIDASSETS_LY,
       A.AVGTOTALLIQUIDASSETS_LY,
       A.TOTALLIABILITIES_LY,
       A.AVGTOTALLIABILITIES_LY,
       A.ACCOUNTSRECEIVABLES_LY,
       A.AVGACCOUNTSRECEIVABLES_LY,
       A.INTERCOMPANYRECEIVABLES_LY,
       A.AVGINTERCOMPANYRECEIVABLES_LY,
       A.PREPAYMENTS_LY,
       A.AVGPREPAYMENTS_LY,
       A.TOTALCURRENTLIABILITIES_LY,
       A.AVGTOTALCURRENTLIABILITIES_LY,
       A.NETCASHOPERATACTIV_LY,
       A.CASHOUTINVESTACTIV_LY,
       A.NETPROFIT_LY,
       A.OPERATINGREVENUE_TTM_LY,
       A.OPERATINGCOSTS_TTM_LY,
       A.TAXANDSURCHARGES_TTM_LY,
       A.SALESCOSTS_TTM_LY,
       A.MANAGEMENTCOSTS_TTM_LY,
       A.EXPLORATIONCOSTS_TTM_LY,
       A.FINANCIALCOSTS_TTM_LY,
       A.ASSESTSDEVALUATION_TTM_LY,
       A.OPERATINGPROFIT_TTM_LY,
       A.TOTALPROFIT_TTM_LY,
       A.INCOMETAX_TTM_LY,
       A.NETPROFIT_TTM_LY,
       A.NETPROAFTEXTRGAINLOSS_TTM_LY,
       A.INTEREST_TTM_LY,
       A.DEPRECFORFIXEDASSETS_TTM_LY,
       A.NETCASHOPERATACTIV_TTM_LY,
       A.CASHOUTINVESTACTIV_TTM_LY,
       A.ROE_LY,
       A.GROSSMARGIN_LY,
       A.ROA_LY,
       A.NETPROFITMARGINONSALES_TTM_LY,
       A.INCOMETAXRATIO_LY,
       A.REINVESTEDINCOMERATIO_LY,
       A.DEPRECIATIONRATIO_LY,
       A.OPERATINGCASHRATIO_TTM_LY,
       A.AVGFIEXDOFASSETS_LY,
       A.FIEXDOFASSETS_LY,
       A.ACIDTESTRATIO_LY,
       A.TURNOVERRATIOOFRECEIVABLE_LY,
       A.TURNOVERRATIOOFINVENTORY_LY,
       A.TURNOVERRATIOOFTOTALASSETS_LY,
       A.DEPRECIATIONOFTOTALCOSTS_LY,
       A.CASHOFNETPROFIT_LY,
       A.CASHOFNETPROFIT_TTM_LY,
       A.CASHOFINTEREST_LY,
       A.ASSETSLIABILITIESRATIO_LY,
       A.TANGIBLEASSETDEBTRATIO_LY,
       A.CASHRATIO_LY,
       A.TOTALASSETS_L2Y,
       A.AVGTOTALASSETS_L2Y,
       A.FIXEDASSETS_L2Y,
       A.AVGFIXEDASSETS_L2Y,
       A.GOODWILL_L2Y,
       A.AVGGOODWILL_L2Y,
       A.INVENTORY_L2Y,
       A.MONEYFUNDS_L2Y,
       A.ACCOUNTSPAYABLE_L2Y,
       A.AVGACCOUNTSPAYABLE_L2Y,
       A.AVGINVENTORY_L2Y,
       A.TOTALLIQUIDASSETS_L2Y,
       A.AVGTOTALLIQUIDASSETS_L2Y,
       A.TOTALLIABILITIES_L2Y,
       A.AVGTOTALLIABILITIES_L2Y,
       A.ACCOUNTSRECEIVABLES_L2Y,
       A.AVGACCOUNTSRECEIVABLES_L2Y,
       A.INTERCOMPANYRECEIVABLES_L2Y,
       A.AVGINTERCOMPANYRECEIVABLES_L2Y,
       A.PREPAYMENTS_L2Y,
       A.AVGPREPAYMENTS_L2Y,
       A.TOTALCURRENTLIABILITIES_L2Y,
       A.AVGTOTALCURRENTLIABILITIES_L2Y,
       A.NETCASHOPERATACTIV_L2Y,
       A.CASHOUTINVESTACTIV_L2Y,
       A.NETPROFIT_L2Y,
       A.OPERATINGREVENUE_TTM_L2Y,
       A.OPERATINGCOSTS_TTM_L2Y,
       A.TAXANDSURCHARGES_TTM_L2Y,
       A.SALESCOSTS_TTM_L2Y,
       A.MANAGEMENTCOSTS_TTM_L2Y,
       A.EXPLORATIONCOSTS_TTM_L2Y,
       A.FINANCIALCOSTS_TTM_L2Y,
       A.ASSESTSDEVALUATION_TTM_L2Y,
       A.OPERATINGPROFIT_TTM_L2Y,
       A.TOTALPROFIT_TTM_L2Y,
       A.INCOMETAX_TTM_L2Y,
       A.NETPROFIT_TTM_L2Y,
       A.NETPROAFTEXTRGAINLOSS_TTM_L2Y,
       A.INTEREST_TTM_L2Y,
       A.DEPRECFORFIXEDASSETS_TTM_L2Y,
       A.NETCASHOPERATACTIV_TTM_L2Y,
       A.CASHOUTINVESTACTIV_TTM_L2Y,
       A.ROE_L2Y,
       A.GROSSMARGIN_L2Y,
       A.ROA_L2Y,
       A.NETPROFITMARGINONSALES_TTM_L2Y,
       A.INCOMETAXRATIO_L2Y,
       A.REINVESTEDINCOMERATIO_L2Y,
       A.DEPRECIATIONRATIO_L2Y,
       A.OPERATINGCASHRATIO_TTM_L2Y,
       A.AVGFIEXDOFASSETS_L2Y,
       A.FIEXDOFASSETS_L2Y,
       A.ACIDTESTRATIO_L2Y,
       A.TURNOVERRATIOOFRECEIVABLE_L2Y,
       A.TURNOVERRATIOOFINVENTORY_L2Y,
       A.TURNOVERRATIOOFTOTALASSETS_L2Y,
       A.DEPRECIATIONOFTOTALCOSTS_L2Y,
       A.CASHOFNETPROFIT_L2Y,
       A.CASHOFNETPROFIT_TTM_L2Y,
       A.CASHOFINTEREST_L2Y,
       A.ASSETSLIABILITIESRATIO_L2Y,
       A.TANGIBLEASSETDEBTRATIO_L2Y,
       A.CASHRATIO_L2Y,
       A.TOTALASSETS_L3Y,
       A.AVGTOTALASSETS_L3Y,
       A.FIXEDASSETS_L3Y,
       A.AVGFIXEDASSETS_L3Y,
       A.GOODWILL_L3Y,
       A.AVGGOODWILL_L3Y,
       A.INVENTORY_L3Y,
       A.MONEYFUNDS_L3Y,
       A.ACCOUNTSPAYABLE_L3Y,
       A.AVGACCOUNTSPAYABLE_L3Y,
       A.AVGINVENTORY_L3Y,
       A.TOTALLIQUIDASSETS_L3Y,
       A.AVGTOTALLIQUIDASSETS_L3Y,
       A.TOTALLIABILITIES_L3Y,
       A.AVGTOTALLIABILITIES_L3Y,
       A.ACCOUNTSRECEIVABLES_L3Y,
       A.AVGACCOUNTSRECEIVABLES_L3Y,
       A.INTERCOMPANYRECEIVABLES_L3Y,
       A.AVGINTERCOMPANYRECEIVABLES_L3Y,
       A.PREPAYMENTS_L3Y,
       A.AVGPREPAYMENTS_L3Y,
       A.TOTALCURRENTLIABILITIES_L3Y,
       A.AVGTOTALCURRENTLIABILITIES_L3Y,
       A.NETCASHOPERATACTIV_L3Y,
       A.CASHOUTINVESTACTIV_L3Y,
       A.NETPROFIT_L3Y,
       A.OPERATINGREVENUE_TTM_L3Y,
       A.OPERATINGCOSTS_TTM_L3Y,
       A.TAXANDSURCHARGES_TTM_L3Y,
       A.SALESCOSTS_TTM_L3Y,
       A.MANAGEMENTCOSTS_TTM_L3Y,
       A.EXPLORATIONCOSTS_TTM_L3Y,
       A.FINANCIALCOSTS_TTM_L3Y,
       A.ASSESTSDEVALUATION_TTM_L3Y,
       A.OPERATINGPROFIT_TTM_L3Y,
       A.TOTALPROFIT_TTM_L3Y,
       A.INCOMETAX_TTM_L3Y,
       A.NETPROFIT_TTM_L3Y,
       A.NETPROAFTEXTRGAINLOSS_TTM_L3Y,
       A.INTEREST_TTM_L3Y,
       A.DEPRECFORFIXEDASSETS_TTM_L3Y,
       A.NETCASHOPERATACTIV_TTM_L3Y,
       A.CASHOUTINVESTACTIV_TTM_L3Y,
       A.ROE_L3Y,
       A.GROSSMARGIN_L3Y,
       A.ROA_L3Y,
       A.NETPROFITMARGINONSALES_TTM_L3Y,
       A.INCOMETAXRATIO_L3Y,
       A.REINVESTEDINCOMERATIO_L3Y,
       A.DEPRECIATIONRATIO_L3Y,
       A.OPERATINGCASHRATIO_TTM_L3Y,
       A.AVGFIEXDOFASSETS_L3Y,
       A.FIEXDOFASSETS_L3Y,
       A.ACIDTESTRATIO_L3Y,
       A.TURNOVERRATIOOFRECEIVABLE_L3Y,
       A.TURNOVERRATIOOFINVENTORY_L3Y,
       A.TURNOVERRATIOOFTOTALASSETS_L3Y,
       A.DEPRECIATIONOFTOTALCOSTS_L3Y,
       A.CASHOFNETPROFIT_L3Y,
       A.CASHOFNETPROFIT_TTM_L3Y,
       A.CASHOFINTEREST_L3Y,
       A.ASSETSLIABILITIESRATIO_L3Y,
       A.TANGIBLEASSETDEBTRATIO_L3Y,
       A.CASHRATIO_L3Y,
       A.TOTALASSETS_L4Y,
       A.AVGTOTALASSETS_L4Y,
       A.FIXEDASSETS_L4Y,
       A.AVGFIXEDASSETS_L4Y,
       A.GOODWILL_L4Y,
       A.AVGGOODWILL_L4Y,
       A.INVENTORY_L4Y,
       A.MONEYFUNDS_L4Y,
       A.ACCOUNTSPAYABLE_L4Y,
       A.AVGACCOUNTSPAYABLE_L4Y,
       A.AVGINVENTORY_L4Y,
       A.TOTALLIQUIDASSETS_L4Y,
       A.AVGTOTALLIQUIDASSETS_L4Y,
       A.TOTALLIABILITIES_L4Y,
       A.AVGTOTALLIABILITIES_L4Y,
       A.ACCOUNTSRECEIVABLES_L4Y,
       A.AVGACCOUNTSRECEIVABLES_L4Y,
       A.INTERCOMPANYRECEIVABLES_L4Y,
       A.AVGINTERCOMPANYRECEIVABLES_L4Y,
       A.PREPAYMENTS_L4Y,
       A.AVGPREPAYMENTS_L4Y,
       A.TOTALCURRENTLIABILITIES_L4Y,
       A.AVGTOTALCURRENTLIABILITIES_L4Y,
       A.NETCASHOPERATACTIV_L4Y,
       A.CASHOUTINVESTACTIV_L4Y,
       A.NETPROFIT_L4Y,
       A.OPERATINGREVENUE_TTM_L4Y,
       A.OPERATINGCOSTS_TTM_L4Y,
       A.TAXANDSURCHARGES_TTM_L4Y,
       A.SALESCOSTS_TTM_L4Y,
       A.MANAGEMENTCOSTS_TTM_L4Y,
       A.EXPLORATIONCOSTS_TTM_L4Y,
       A.FINANCIALCOSTS_TTM_L4Y,
       A.ASSESTSDEVALUATION_TTM_L4Y,
       A.OPERATINGPROFIT_TTM_L4Y,
       A.TOTALPROFIT_TTM_L4Y,
       A.INCOMETAX_TTM_L4Y,
       A.NETPROFIT_TTM_L4Y,
       A.NETPROAFTEXTRGAINLOSS_TTM_L4Y,
       A.INTEREST_TTM_L4Y,
       A.DEPRECFORFIXEDASSETS_TTM_L4Y,
       A.NETCASHOPERATACTIV_TTM_L4Y,
       A.CASHOUTINVESTACTIV_TTM_L4Y,
       A.ROE_L4Y,
       A.GROSSMARGIN_L4Y,
       A.ROA_L4Y,
       A.NETPROFITMARGINONSALES_TTM_L4Y,
       A.INCOMETAXRATIO_L4Y,
       A.REINVESTEDINCOMERATIO_L4Y,
       A.DEPRECIATIONRATIO_L4Y,
       A.OPERATINGCASHRATIO_TTM_L4Y,
       A.AVGFIEXDOFASSETS_L4Y,
       A.FIEXDOFASSETS_L4Y,
       A.ACIDTESTRATIO_L4Y,
       A.TURNOVERRATIOOFRECEIVABLE_L4Y,
       A.TURNOVERRATIOOFINVENTORY_L4Y,
       A.TURNOVERRATIOOFTOTALASSETS_L4Y,
       A.DEPRECIATIONOFTOTALCOSTS_L4Y,
       A.CASHOFNETPROFIT_L4Y,
       A.CASHOFNETPROFIT_TTM_L4Y,
       A.CASHOFINTEREST_L4Y,
       A.ASSETSLIABILITIESRATIO_L4Y,
       A.TANGIBLEASSETDEBTRATIO_L4Y,
       A.CASHRATIO_L4Y,
       A.TOTALASSETS_L5Y,
       A.AVGTOTALASSETS_L5Y,
       A.FIXEDASSETS_L5Y,
       A.AVGFIXEDASSETS_L5Y,
       A.GOODWILL_L5Y,
       A.AVGGOODWILL_L5Y,
       A.INVENTORY_L5Y,
       A.MONEYFUNDS_L5Y,
       A.ACCOUNTSPAYABLE_L5Y,
       A.AVGACCOUNTSPAYABLE_L5Y,
       A.AVGINVENTORY_L5Y,
       A.TOTALLIQUIDASSETS_L5Y,
       A.AVGTOTALLIQUIDASSETS_L5Y,
       A.TOTALLIABILITIES_L5Y,
       A.AVGTOTALLIABILITIES_L5Y,
       A.ACCOUNTSRECEIVABLES_L5Y,
       A.AVGACCOUNTSRECEIVABLES_L5Y,
       A.INTERCOMPANYRECEIVABLES_L5Y,
       A.AVGINTERCOMPANYRECEIVABLES_L5Y,
       A.PREPAYMENTS_L5Y,
       A.AVGPREPAYMENTS_L5Y,
       A.TOTALCURRENTLIABILITIES_L5Y,
       A.AVGTOTALCURRENTLIABILITIES_L5Y,
       A.NETCASHOPERATACTIV_L5Y,
       A.CASHOUTINVESTACTIV_L5Y,
       A.NETPROFIT_L5Y,
       A.OPERATINGREVENUE_TTM_L5Y,
       A.OPERATINGCOSTS_TTM_L5Y,
       A.TAXANDSURCHARGES_TTM_L5Y,
       A.SALESCOSTS_TTM_L5Y,
       A.MANAGEMENTCOSTS_TTM_L5Y,
       A.EXPLORATIONCOSTS_TTM_L5Y,
       A.FINANCIALCOSTS_TTM_L5Y,
       A.ASSESTSDEVALUATION_TTM_L5Y,
       A.OPERATINGPROFIT_TTM_L5Y,
       A.TOTALPROFIT_TTM_L5Y,
       A.INCOMETAX_TTM_L5Y,
       A.NETPROFIT_TTM_L5Y,
       A.NETPROAFTEXTRGAINLOSS_TTM_L5Y,
       A.INTEREST_TTM_L5Y,
       A.DEPRECFORFIXEDASSETS_TTM_L5Y,
       A.NETCASHOPERATACTIV_TTM_L5Y,
       A.CASHOUTINVESTACTIV_TTM_L5Y,
       A.ROE_L5Y,
       A.GROSSMARGIN_L5Y,
       A.ROA_L5Y,
       A.NETPROFITMARGINONSALES_TTM_L5Y,
       A.INCOMETAXRATIO_L5Y,
       A.REINVESTEDINCOMERATIO_L5Y,
       A.DEPRECIATIONRATIO_L5Y,
       A.OPERATINGCASHRATIO_TTM_L5Y,
       A.AVGFIEXDOFASSETS_L5Y,
       A.FIEXDOFASSETS_L5Y,
       A.ACIDTESTRATIO_L5Y,
       A.TURNOVERRATIOOFRECEIVABLE_L5Y,
       A.TURNOVERRATIOOFINVENTORY_L5Y,
       A.TURNOVERRATIOOFTOTALASSETS_L5Y,
       A.DEPRECIATIONOFTOTALCOSTS_L5Y,
       A.CASHOFNETPROFIT_L5Y,
       A.CASHOFNETPROFIT_TTM_L5Y,
       A.CASHOFINTEREST_L5Y,
       A.ASSETSLIABILITIESRATIO_L5Y,
       A.TANGIBLEASSETDEBTRATIO_L5Y,
       A.CASHRATIO_L5Y,
       A.TOTALASSETS_LQ,
       A.AVGTOTALASSETS_LQ,
       A.FIXEDASSETS_LQ,
       ...
       A.INVENTORY_LQ,
       A.MONEYFUNDS_LQ,
       A.ACCOUNTSPAYABLE_LQ,
       A.AVGACCOUNTSPAYABLE_LQ,
       A.AVGINVENTORY_LQ,
       A.TOTALLIQUIDASSETS_LQ,
       A.AVGTOTALLIQUIDASSETS_LQ,
       A.TOTALLIABILITIES_LQ,
       A.AVGTOTALLIABILITIES_LQ,
       A.ACCOUNTSRECEIVABLES_LQ,
       A.AVGACCOUNTSRECEIVABLES_LQ,
       A.INTERCOMPANYRECEIVABLES_LQ,
       A.AVGINTERCOMPANYRECEIVABLES_LQ,
       A.PREPAYMENTS_LQ,
       A.AVGPREPAYMENTS_LQ,
       A.TOTALCURRENTLIABILITIES_LQ,
       A.AVGTOTALCURRENTLIABILITIES_LQ,
       A.NETCASHOPERATACTIV_LQ,
       A.CASHOUTINVESTACTIV_LQ,
       A.NETPROFIT_LQ,
       A.OPERATINGREVENUE_TTM_LQ,
       A.OPERATINGCOSTS_TTM_LQ,
       A.TAXANDSURCHARGES_TTM_LQ,
       A.SALESCOSTS_TTM_LQ,
       A.MANAGEMENTCOSTS_TTM_LQ,
       A.EXPLORATIONCOSTS_TTM_LQ,
       A.FINANCIALCOSTS_TTM_LQ,
       A.ASSESTSDEVALUATION_TTM_LQ,
       A.OPERATINGPROFIT_TTM_LQ,
       A.TOTALPROFIT_TTM_LQ,
       A.INCOMETAX_TTM_LQ,
       A.NETPROFIT_TTM_LQ,
       A.NETPROAFTEXTRGAINLOSS_TTM_LQ,
       A.INTEREST_TTM_LQ,
       A.DEPRECFORFIXEDASSETS_TTM_LQ,
       A.NETCASHOPERATACTIV_TTM_LQ,
       A.CASHOUTINVESTACTIV_TTM_LQ,
       A.ROE_LQ,
       A.GROSSMARGIN_LQ,
       A.ROA_LQ,
       A.NETPROFITMARGINONSALES_TTM_LQ,
       A.INCOMETAXRATIO_LQ,
       A.REINVESTEDINCOMERATIO_LQ,
       A.DEPRECIATIONRATIO_LQ,
       A.OPERATINGCASHRATIO_TTM_LQ,
       A.AVGFIEXDOFASSETS_LQ,
       A.FIEXDOFASSETS_LQ,
       A.ACIDTESTRATIO_LQ,
       A.TURNOVERRATIOOFRECEIVABLE_LQ,
       A.TURNOVERRATIOOFINVENTORY_LQ,
       A.TURNOVERRATIOOFTOTALASSETS_LQ,
       A.DEPRECIATIONOFTOTALCOSTS_LQ,
       A.CASHOFNETPROFIT_LQ,
       A.CASHOFNETPROFIT_TTM_LQ,
       A.CASHOFINTEREST_LQ,
       A.ASSETSLIABILITIESRATIO_LQ,
       A.TANGIBLEASSETDEBTRATIO_LQ,
       A.CASHRATIO_LQ,
       A.I_TOTAL_MARKET,
       A.I_NETPROAFTEXTRGAINLOSS_TTM,
       A.I_AVGTOTALASSETS,
       A.I_AVGGOODWILL,
       A.I_AVGTOTALLIABILITIES,
       A.I_OPERATINGREVENUE_TTM,
       A.INDUSTRYOPERATINGCOSTS_TTM,
       A.ALL_TOTAL_MARKET,
       A.ALL_NETPROAFTEXTRGAINLOSS_TTM,
       A.ALL_AVGTOTALASSETS,
       A.ALL_AVGGOODWILL,
       A.ALL_AVGTOTALLIABILITIES,
       A.ALL_OPERATINGREVENUE_TTM,
       A.ALL_OPERATINGCOSTS_TTM,
       A.I_PE_TOTAL,
       A.I_PB_TOTAL,
       A.I_ROE_TOTAL,
       A.I_GROSSMARGIN_TOTAL,
       A.I_ROA_TOTAL,
       A.I_PE,
       A.I_PB,
       A.I_GROSSMARGIN,
