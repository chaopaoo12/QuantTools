import pandas as pd
from QUANTTOOLS.QAStockETL.QAFetch.QAQuery_Advance import QA_fetch_get_stock_quant_pre_adv
...
def get_quant_data(start_date, end_date, block = False):
    ...
    res = QA_fetch_get_stock_quant_pre_adv(codes,start_date,end_date )
    return(res)