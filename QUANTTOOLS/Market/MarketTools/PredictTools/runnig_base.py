...
def predict_base(trading_date, predict_func, model_name, file_name, top_num, percent, working_dir, client_setting, exceptions,
                 name_list = None, value_ist = None, sort_mark = None, selec_list = None):
    ...
    prediction_report(QA_util_get_real_date(trading_date), stock_tar, stock_b, model_date, model_name, target, top_num, client_setting, exceptions, percent, account='name:client-1',
                      name_list = name_list,
                      value_ist = value_ist,
                      sort_mark = sort_mark,
                      selec_list = selec_list,ui_log = None)
