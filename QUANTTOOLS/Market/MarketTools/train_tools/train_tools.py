...
def load_data(model, start_date, end_date, type ='model', norm_type=None, sub_block=False, ui_log=None):
    ...
    model.get_data(start=start_date, end= end_date, type =type,sub_block=sub_block, norm_type=norm_type)
    return(model)
