...
def prediction_report(trading_date, target_pool, prediction, model_date, top_num, exceptions, percent,
                      ...
                      value_ist = ['Z_PROB','O_PROB','RANK','SKDJ_K_WK','SKDJ_TR_WK','SKDJ_K','SKDJ_TR','SKDJ_K_HR','SKDJ_TR_HR','RSI1','RSI3','TARGET','TARGET3','TARGET4','TARGET5','PASS_MARK','ATRR','UB','LB','WIDTH','UB_HR','LB_HR','WIDTH_HR'],
                      sort_mark ='RANK',
