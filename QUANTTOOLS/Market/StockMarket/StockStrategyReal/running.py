...
def predict_index(trading_date, working_dir=working_dir, exceptions=exceptions):
    predict_index_base(trading_date, concat_predict_index, model_name = 'index_mars_day', file_name = 'prediction_index', top_num=10, working_dir=working_dir, exceptions=exceptions)
