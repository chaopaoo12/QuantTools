...
def predict_watch(trading_date, working_dir=working_dir):
    ...
    data = data[(data.NETPROFIT_INRATE > 50)&(data.ROE_TTM >= 10)&(data.ROE >= 1)&(data.SHORT10.abs() < 0.01)&(data.SHORT20 < 0)&(data.SHORT20 > -0.01)&(data.MA60.abs() < 0.01)][['INDUSTRY','NETPROFIT_INRATE','ROE_TTM','PE_TTM','SHORT10','SHORT20','MA60_C','PASS_MARK','TARGET','TARGET3','TARGET4','TARGET5','TARGET10','TARGET20','SKDJ_K','SKDJ_TR','SKDJ_K_HR','SKDJ_TR_HR','MA60']]
