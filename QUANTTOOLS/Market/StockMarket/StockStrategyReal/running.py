...
def predict_target(trading_date, working_dir=working_dir):
    ...
    out_ist = res[(res.SKDJ_CROSS1_30M == 1 and res.MA5_30M < 0) | (res.SKDJ_TR_30M < 1 and res.MA5_30M < 0)].loc[(slice(None),target_list),][['SKDJ_K_HR','SKDJ_TR_HR','SKDJ_K_30M','SKDJ_TR_30M','MA5_30M','PASS_MARK','TARGET','TARGET3','TARGET4','TARGET5']]
