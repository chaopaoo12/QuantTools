...
def code_select(target_list, position, day_temp_data, sec_temp_data, trading_date, mark_tm, proxies):
    ...
    sec_temp_data['BOLL_15M_V'] = sec_temp_data['close_15'] / (sec_temp_data['BOLL_15M'] + 1)
    sec_temp_data['LB_15M_V'] = sec_temp_data['close_15'] / (sec_temp_data['LB_15M'] + 1)
    sec_temp_data['UB_15M_V'] = sec_temp_data['close_15'] / (sec_temp_data['UB_15M'] + 1)
    sec_temp_data['BOLL_30M_V'] = sec_temp_data['close_30'] / (sec_temp_data['BOLL_30M'] + 1)
    sec_temp_data['LB_30M_V'] = sec_temp_data['close_30'] / (sec_temp_data['LB_30M'] + 1)
    sec_temp_data['UB_30M_V'] = sec_temp_data['close_30'] / (sec_temp_data['UB_30M'] + 1)
