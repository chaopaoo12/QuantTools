...
def code_select(buy_list, tmp_list, position, trading_date, mark_tm):
    ...
    if mark_tm in time_index + ['09:31:00'] or tmp_list is None:
        ...
        QA_util_log_info(data_15min[['RRNG_HR','RRNG_30M','SKDJ_K_30M','SKDJ_D_30M','SKDJ_K_HR','SKDJ_D_HR']], ui_log=None)

        QA_util_log_info('##Target Pool ==================== {}'.format(stm), ui_log=None)
        QA_util_log_info(data_15min[(data_15min.RRNG_HR.abs() <= 0.1)&(data_15min.RRNG_30M.abs() <= 0.05)][
                             ['RRNG_HR','RRNG_30M','SKDJ_K_30M','SKDJ_D_30M','SKDJ_K_HR','SKDJ_D_HR']], ui_log=None)
