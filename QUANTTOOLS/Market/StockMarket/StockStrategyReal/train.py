...
def train(date, working_dir=working_dir):
    ...
    min_model = prepare_data(min_model, date, mark = -5, col = 'TERNS_15M', type='shift', k = 0, start = "-01-01", shift=2)
    ...
    hour_model = prepare_data(hour_model, date, mark = -5, col = 'TERNS_HR', type='shift', k = 1, start = "-01-01", shift=2)
