...
from .setting import working_dir, stock_day_set, stock_hour_set, index_day_set, index_hour_set
...
def train_index(date, working_dir=working_dir):
    ...
    hour_model = start_train(hour_model, index_day_set, other_params, 0, 0.99)
