...
from QUANTTOOLS.Market.MarketTools import make_prediction

def concat_predict(trading_date, working_dir, model_name = 'stock_xg'):
    Stock = QAStockXGBoost()
    stock_info_temp = Stock.info
    target_pool,prediction,start,end,stock_info_temp['date'] = make_prediction(Stock, trading_date, model_name, working_dir)
