...
def concat_predict(trading_date, working_dir, code = None, type = 'crawl', model_name = 'stock_xg'):
...
def concat_predict_hour(trading_date, working_dir, code = None, type = 'crawl', model_name = 'stock_xg'):
...
def concat_predict_15min(trading_date, working_dir, code = None, type = 'crawl', model_name = 'stock_xg'):
