...
def predict(trading_date, strategy_id='机器学习1号', account1='name:client-1', working_dir=working_dir, ui_log = None):
    ...
    stock_list,report,top_report = check_model(model_temp, QA_util_get_last_day(trading_date,1),QA_util_get_last_day(trading_date,1),info_temp['cols'], 0.42, type = 'percent')
